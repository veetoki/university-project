 ...
 * Generated for Laravel 5.5.40 on 2018-06-27 07:40:02.
 *
...
namespace App\lib\Facades { 
    ...
    class Tool {
        ...
        {
            \App\lib\ToolFactory::getThumbnail($fileName, $suffix);
        }
        ...
        {
            return \App\lib\ToolFactory::getCurrencyVN($number, $symbol, $isPrefix);
        }
